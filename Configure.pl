...
the location of parrot_config to be used to build parrotlog.

END
    }

    # Verify the Parrot installation is sufficient for building parrotlog
...
You can now use '$make' to build parrotlog.
...
sub print_help {
    print <<'END';
Configure.pl - parrotlog Configure
